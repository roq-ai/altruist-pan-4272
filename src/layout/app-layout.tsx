...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Bike', path: '/bikes', entity: 'bike', service: AccessServiceEnum.PROJECT, icon: FiActivity },
    { name: 'Game Mode', path: '/game-modes', entity: 'game_mode', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Leaderboard',
      path: '/leaderboards',
      entity: 'leaderboard',
    ...
    { name: 'Power Up', path: '/power-ups', entity: 'power_up', service: AccessServiceEnum.PROJECT, icon: FiPower },
    { name: 'Track', path: '/tracks', entity: 'track', service: AccessServiceEnum.PROJECT, icon: FiMap },
    {
      name: 'Upgrade',
      path: '/upgrades',
      entity: 'upgrade',
