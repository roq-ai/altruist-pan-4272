...
import { getAiOpponentById } from 'apiSdk/ai-opponents';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Ai Opponent Detail View
          </Text>
          {hasAccess('ai_opponent', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/ai-opponents/edit/${data?.id}`} passHref legacyBehavior>
              <Button
